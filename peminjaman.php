                            ...
                            <td><?php echo $i++; ?></td>
                                ...
                                <div class="row">
                                    ...
                                    <form method="post" action="simpan_koleksi.php" style="">
                                            ...
                                            <button type="submit" name="simpan" class="btn btn-success" style="margin-right: 5px; border-radius: 20px; min-width: 100px;" onclick="return confirm('Apakah anda yakin menyimpan data ini?');">Simpan</button>
                                        </form>
                                    </div>
                                </div>
                            </td>
