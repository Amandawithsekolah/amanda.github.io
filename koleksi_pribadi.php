                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- Tombol Hapus -->
                                    <a onclick="return confirm('Apakah anda yakin menghapus data ini?');" href="?page=koleksi_pribadi_hapus&&id=<?php echo $data['id_koleksi']; ?>" class="btn btn-danger" style="margin-right: 5px; border-radius: 20px; min-width: 100px;">Hapus</a>
                                </td>
                            </tr>
                        <?php
                        }
