                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($_SESSION['user']['level'] == 'peminjam' && $data['id_user'] == $user_id) { ?>
                                    <a href="?page=ulasan_ubah&&id=<?php echo $data['id_ulasan']; ?>" class="btn btn-info" style="margin-right: 5px; border-radius: 20px; min-width: 100px;">Ubah</a>
                                    <a onclick="return confirm('Apakah anda yakin menghapus data ini?');" href="?page=ulasan_hapus&&id=<?php echo $data['id_ulasan']; ?>" class="btn btn-danger" style="margin-right: 5px; border-radius: 20px; min-width: 100px;">Hapus</a>
