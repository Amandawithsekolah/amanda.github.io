...
<html lang="en">
    ...
    <body style="background-image: url('assets/img/bg login.png');" class="bg-dark">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">REGISTER PERPUS WEB DIGITAL</h3></div>
                                    <div class="card-body">
                                        <?php
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <a class="btn btn-warning" href="login.php">Kembali ke halaman login</a>
                                            </div>
                                        </form>
                                    </div>
